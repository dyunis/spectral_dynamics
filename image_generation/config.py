...
parser.add_argument('--timesteps', type=int, default=1000, help='diffusion timesteps to use')

# model args
parser.add_argument('--model_arch', type=str, default='unet', choices=['mlp', 'unet'], help='which model to use')
...
parser.add_argument('--ema_gamma', type=float, default=0.0, help='ema gamma to use, 0.0 corresponds to no ema')
