...
def main(config, run_configs):
    ...
    perturb_scale = run_configs[0].perturb_scale
    # perturb_type = run_configs[0].perturb_bottom_half
    perturb_type = run_configs[0].perturb_type
    ...
    savedir = os.path.join(group_dir, 'lmc', f'trunk-{trunk_seed}_split-{split_step}_seed-{branch_seeds[0]}_seed-{branch_seeds[1]}_pertscale-{perturb_scale}_perttype-{perturb_type}')
